...
Der vollständige Single-File-Code, der die Anwendung, das CSS und das JavaScript enthält.
...
(Erforderlich) Die JSON-Datei, die die Katalogeinträge enthält (wird von JS asynchron geladen).
...
(Erforderlich) Das Bild, das im "Handbuch" verwendet wird.
